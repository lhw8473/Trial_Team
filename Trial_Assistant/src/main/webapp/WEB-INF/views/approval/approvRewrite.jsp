...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="shortcut ico n" type="image/x-icon" href="assets/img/favicon.ico">
                ...
                <div class="table-box col-lg second-section">
                    ...
                    <div>
                        ...
                        <div>
                            <div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <span class="input-group-text">승인 상태</span>
                                    <div class="category-content" style="border: 1px solid #d6d6d6; padding:0 20px; display: flex; align-items: center;" >
                                        <input type="radio" name="group2" value="승인">&nbsp;<h6 style="margin-top: 7px;">승인</h6> &nbsp;
                                        <input type="radio" name="group2" value="미승인">&nbsp;<h6 style="margin-top: 7px;">미승인</h6> &nbsp;
                                    </div>
                        ...
                        <div class="notice-regi-btn">
                            ...
                            <button class="btn btn-outline-secondary" type="file" id="inputGroupFileAddon04">승인변경하기</button>
