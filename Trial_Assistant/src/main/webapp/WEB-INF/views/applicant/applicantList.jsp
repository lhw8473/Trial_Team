      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <ul class="list-unstyled templatemo-accordion">
            ...
            <li class="pb-3">
              <a class="collapsed d-flex justify-content-between h3 text-decoration-none myInfo" onclick="location.href='<c:url value="/approval/approvalList?page=1&cpp=10"/>'">
                조력자 신청/선정 현황
              </a>
            </li>
            <li class="pb-3">
      ...
      <section class="py-3 total-sec ">
        <div class="table-box col-lg second-section ">
          ...
          <div class="announcement-search dropdown" style="width: 500px; display: flex; justify-content: flex-end;">
            ...
            <input type="text" class="announcement-search-input" placeholder="검색할 아이디를 입력하세요." style="width: 300px;" />
